...
export const TOPICS = {
  5: [
    { id: "toplama", name: "Toplama Islemi", icon: "Plus" },
    { id: "cikarma", name: "Cikarma Islemi", icon: "Minus" },
    { id: "carpma", name: "Carpma Islemi", icon: "X" },
    { id: "bolme", name: "Bolme Islemi", icon: "Divide" },
    { id: "kesirToplama", name: "Kesirlerle Toplama", icon: "Percent" },
  ],
  6: [
    { id: "tamSayiToplama", name: "Tam Sayilarla Toplama", icon: "PlusCircle" },
    { id: "tamSayiCarpma", name: "Tam Sayilarla Carpma", icon: "XCircle" },
    { id: "oran", name: "Oran ve Oranti", icon: "Scale" },
    { id: "obeb", name: "OBEB", icon: "GitMerge" },
    { id: "okek", name: "OKEK", icon: "GitBranch" },
  ],
  7: [
    { id: "yuzde", name: "Yuzde Hesaplama", icon: "Percent" },
    { id: "denklem", name: "Denklem Cozme", icon: "Equal" },
    { id: "cemberCevre", name: "Cember ve Daire", icon: "Circle" },
    { id: "esitsizlik", name: "Esitsizlikler", icon: "ArrowLeftRight" },
    { id: "aciHesaplama", name: "Acilar", icon: "Triangle" },
  ],
  8: [
    { id: "usluSayilar", name: "Uslu Sayilar", icon: "Superscript" },
    { id: "karekok", name: "Karekok", icon: "SquareRoot" },
    { id: "denklemSistemi", name: "Denklem Sistemleri", icon: "Workflow" },
    { id: "pitagor", name: "Pitagor Teoremi", icon: "Triangle" },
    { id: "olasilik", name: "Olasilik", icon: "Dice5" },
  ],
} as const;
